...
"use strict";var e=a(require("lodash/throttle"));function a(e){return e&&e.__esModule?e:{default:e}}const t=document.querySelector(".feedback-form"),s={email:t.email.value,message:t.message.value},l="feedback-form-state";function r(e){e.preventDefault();const a={email:e.currentTarget.email.value,message:e.currentTarget.message.value};""!==a.email&&""!==a.message&&(console.log(a),localStorage.removeItem(l),t.reset())}function m({target:{name:e,value:a}}){s[e]=a,localStorage.setItem(l,JSON.stringify(s))}function n(){const e=JSON.parse(localStorage.getItem(l));e&&(e.email&&(t.email.value=e.email),e.message&&(t.message.value=e.message))}t.addEventListener("submit",r),t.addEventListener("input",(0,e.default)(m,500)),n();
},{"lodash/throttle":"Ywd4"}]},{},["TTyb"], null)
//# sourceMappingURL=/goit-js-hw-08/03-feedback.ec86e3aa.js.map