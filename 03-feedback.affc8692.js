...
"use strict";var e=t(require("lodash/throttle"));function t(e){return e&&e.__esModule?e:{default:e}}const a=document.querySelector(".feedback-form"),o=document.querySelector(".feedback-form textarea"),r={};function n(e){e.preventDefault(),e.currentTarget.reset(),localStorage.removeItem("feedback-form-state")}function c(e){const t=e.target.value;localStorage.setItem("feedback-form-state",t)}function u(){const e=localStorage.getItem("feedback-form-state");e&&(console.log(e),o.value=e)}a.addEventListener("submit",n),o.addEventListener("input",(0,e.default)(c,500)),u(),a.addEventListener("input",e=>{r[e.target.name]=e.target.value,console.log(r)});
},{"lodash/throttle":"Ywd4"}]},{},["TTyb"], null)
//# sourceMappingURL=/goit-js-hw-08/03-feedback.affc8692.js.map